...
function UserSelect({ update_user_id }: { update_user_id: (new_user_id: string) => void }) {
        ...
        axios
            ...
            .then((res) => {
                ...
                if (user_id !== prev_user_id) {
                    ...
                    // TODO update page state upon login
