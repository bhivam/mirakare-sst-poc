...
function App() {
  ...
  async function GetText(audio_file: File) {
    ...
    const res = await axios.post("https://api.openai.com/v1/audio/transcriptions", form_data, {
      headers: {
  ...
  function SetupStream(stream: MediaStream) {
    ...
    recorder.current.onstop = (e: Event) => {
      ...
      GetText(audio_file).then((transcription) => setText(transcription.text));
  ...
  return (
    <div className="flex justify-center">
      <div className="flex justify-center flex-col px-8 md:w-1/2">
